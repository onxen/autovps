...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/onxen/autovps/master/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
wget -O delss "https://raw.githubusercontent.com/onxen/autovps/master/shadowsocks/delss.sh"
cd
